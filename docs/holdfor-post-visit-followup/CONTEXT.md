...
calendar date. See [ADR 0008](../adr/0008-an-offered-slot-is-matched-never-resolved.md).
...
scheduling. See [ADR 0011](../adr/0011-the-rebooking-call-speaks-from-a-closed-list.md).
...
08:50. See [ADR 0012](../adr/0012-the-last-acceptance-binds-and-every-offer-is-kept.md).
...
`reception_declined`. See [ADR 0010](../adr/0010-a-rebooking-outcome-is-not-a-checkin-outcome.md).
