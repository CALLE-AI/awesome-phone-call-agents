...
| --- | --- | --- |
| [`typescript/multi-party-scheduler`](typescript/multi-party-scheduler/) | TypeScript | Two-phase booking over phone calls: gather availability, confirm one time with everybody, release everybody who confirmed when the commit fails. |
