...
| [`python/ontripfix`](python/ontripfix/) | Python / FastAPI / React | Autonomous Airflow incident remediation with Call-E Voice AI on-call engineer authorization and LangGraph StateGraph self-healing, with a dry-run default. |
