...
| [`typescript/ai-front-desk`](typescript/ai-front-desk/) | TypeScript | AI receptionist for appointment businesses: confirms appointments, backfills freed slots via a priority call waterfall, and qualifies new leads into bookings, all off one shared calendar. |
