...
| [`typescript/collex-ai`](typescript/collex-ai/) | TypeScript | Lead follow-up call-agent that turns a lead into a RAG-personalized CALL-E task, then classifies CALL-E's structured call result into hot/warm/lost outcomes. Dry-run-by-default with fixture leads no database or real credentials needed to run. |
