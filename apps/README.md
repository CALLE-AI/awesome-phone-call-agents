...
| [PartFinder AI](https://github.com/atsushiyago/partfinder-ai) | TypeScript / Next.js | Local-parts search dashboard with explicit CALL-E call initiation, server-side credentials, structured inventory comparison, and a returned call log. |
