...
function CaseRail({
  ...
  return (
    <aside
      ...
      aria-label="Closeout cases"
    >
      <div className="rail-heading">
        <div>
          <span>Operations queue</span>
          <strong>Closeout cases</strong>
        </div>
...
function LiveCallView({
  ...
  const claimed = Boolean(detail.attempt?.requestedAt);
    ...
    <div className="simulation-layout live-call-layout">
      <div className="simulation-hero live-call-hero">
        ...
        <h3>
          {needsReconciliation
            ...
            : claimed
              ? "The request is claimed and cannot be duplicated."
      ...
      <aside className="scenario-picker live-call-action">
        ...
        <button
          ...
          disabled={busy || (!accepted && claimed)}
