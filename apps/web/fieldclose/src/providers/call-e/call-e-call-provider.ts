...
function buildBoundedTask(brief: ApprovedCallBrief) {
  ...
  return [
    ...
    "Decline technical, emergency, commercial, payment, and commitment requests; direct the recipient to a human contractor contact and record the appropriate out-of-scope or escalation code.",
