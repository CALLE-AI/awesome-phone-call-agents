...
function render(){paintNav();paintHeader();var main=document.getElementById('main');clear(main);if(S.view==='overview')renderOverview(main);else if(S.view==='claims')renderClaims(main);else if(S.view==='new-claim')renderNewClaim(main);else if(S.view==='calls')renderCalls(main);else if(S.view==='review')renderReview(main);else if(S.view==='claim')renderClaim(main,S.detail);else if(S.view==='call')renderCall(main,S.detail);else{S.view='overview';renderOverview(main);}}
