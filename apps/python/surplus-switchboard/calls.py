...
def build_request(context: dict, now: int) -> tuple[dict,str]:
    ...
    if test_mode:
        introduction=(
          ...
          'If call screening or an interruption asks your name or reason, identify yourself as an AI assistant '
          'calling on behalf of the operator, never as the operator or a human. After the recipient joins, '
          'repeat the full AI, recording and fictional-role-play disclosure before seeking consent. '
