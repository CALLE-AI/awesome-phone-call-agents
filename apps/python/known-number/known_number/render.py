...
from .models import ChangeRequest, Reconciliation, VendorRecord, mask_phone, callback_reference
...
def audit_record(
    ...
    *,
    ...
    return {
        ...
        "approver": approver,
        "callback_reference": callback_reference(request, code_secret),
...
def memo(record: dict[str, Any], request: ChangeRequest, vendor: VendorRecord) -> str:
    ...
    lines = [
        ...
        f"- Callback reference spoken on the call, to be quoted in the written reply: `{record.get('callback_reference', 'n/a')}`",
        "",
        "## What was dialed",
        "",
