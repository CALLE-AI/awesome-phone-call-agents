...
- Referee phone numbers are call inputs; they are not persisted by this app
  beyond the result row, and are masked in all output. Every sample number in
  this app and its tests comes from a regulator-reserved fiction range and
  cannot route to a real subscriber: the NANP `555-0100`-`555-0199` block
  (ATIS/NANPA), and Ofcom's UK drama ranges `020 7946 0xxx` and `01632 960xxx`.
