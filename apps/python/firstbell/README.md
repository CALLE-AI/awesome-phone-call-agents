...
| 4 | [`evidence/MUTATIONS.md`](evidence/MUTATIONS.md) | One hundred and eighty-two gates broken on purpose, with how many tests noticed each one | 1 min |
...
python -m pytest tests/ -q          # 411 tests
```
