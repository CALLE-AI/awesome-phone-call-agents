...
| [`film.json`](film.json) | What the demo film measures out at: 2:21.7, 23 shots, 82.9% of the running time carrying sound above -50dB, -16.1 LUFS, and the sha256 of the file those numbers were read off. The film itself is held outside this repository. |
