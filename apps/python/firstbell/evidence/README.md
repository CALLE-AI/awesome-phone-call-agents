...
| [`film.json`](film.json) | What the demo film measures out at: 2:44.2, 25 shots, 87.6% of the running time carrying sound above -50dB, -16.0 LUFS, and the sha256 of the file those numbers were read off. The film itself is held outside this repository. |
