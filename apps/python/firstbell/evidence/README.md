...
| [`film.json`](film.json) | What the demo film measures out at: 2:44.2, 26 shots, 97.4% of the running time carrying sound above -50dB, -15.9 LUFS, and the sha256 of the file those numbers were read off. The film itself is held outside this repository. |
