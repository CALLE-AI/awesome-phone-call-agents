...
| [`film.json`](film.json) | What the demo film measures out at: 2:39.6, 26 shots, 89.1% of the running time carrying sound above -50dB, -15.3 LUFS, and the sha256 of the file those numbers were read off. The film itself is held outside this repository. |
