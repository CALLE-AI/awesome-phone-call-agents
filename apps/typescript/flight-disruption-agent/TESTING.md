...
Everything below runs in dry run by default: no CALL-E account, no API key, no phone calls, fictional data. Live calls are optional and covered at the end.
...
Expected: `# pass 79`, `# fail 0`, and no type errors.

## 3. Terminal walkthroughs
...
Open http://127.0.0.1:4310. The header shows **DRY RUN** and a **demo clock** (19 September 2026, the day before the fictional flights). Use **Reset demo** at any time to start over.
...
## 5. Safety checks you can verify
...
## 6. Live calls (optional, places real calls)
