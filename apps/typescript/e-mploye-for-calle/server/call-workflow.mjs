...
const seedState = (liveEnabled = false) => {
  const employees = liveEnabled ? [] : [
    { id: "emp-ana", name: "Ana Morales", role: "Customer · Luna Studio", business: "Luna Studio", phone: "+14155550101", locale: "en-US", region: "MX" },
    { id: "emp-diego", name: "Diego Rivera", role: "Prospect · Norte Services", business: "Norte Services", phone: "+14155550102", locale: "en-US", region: "MX" },
    { id: "emp-lucia", name: "Lucía Torres", role: "Team member · Calle Ops", business: "Calle Ops", phone: "+14155550103", locale: "en-US", region: "MX" },
  ];
