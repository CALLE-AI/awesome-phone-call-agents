    ...
    <div className="app-shell guided-app">
      ...
      <main className={`guided-content ${view === "flow" ? "is-flow" : "is-dashboard"}`}>
        ...
        {view === "dashboard" ? <section className="dashboard-view">
          ...
          <section className="impact-strip" aria-label="Appointment desk impact"><div className="impact-story"><p className="eyebrow">PRIMARY USE CASE · APPOINTMENT DESK</p><h2>Recover the time hidden in routine confirmation calls.</h2><p>For a service team handling 40 appointments a day, a 25% phone follow-up rate at four minutes per attempt represents roughly 40 minutes of manual work that E-mploye can prepare, route, and document for human review.</p><small>Illustrative operating scenario, not a measured customer claim.</small></div><div className="impact-metrics"><div><strong>40</strong><span>appointments / day</span></div><div><strong>25%</strong><span>need follow-up</span></div><div><strong>40 min</strong><span>potentially recovered / day</span></div></div></section>
          <section className="judge-path panel" aria-label="Judge quick path"><div><p className="eyebrow">JUDGE QUICK PATH</p><h2>See the safety boundary in under 90 seconds.</h2><p className="section-copy">Choose Appointment reschedule, preview the exact task, request approval, run the sandbox, inspect the evidence, and apply or reject the proposed change.</p></div><div className="judge-steps"><span><b>1</b>Choose</span><span><b>2</b>Preview</span><span><b>3</b>Approve</span><span><b>4</b>Review</span><span><b>5</b>Decide</span></div></section>
