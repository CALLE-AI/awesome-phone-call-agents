...
- Use standards-reserved fictional numbers (`+15550100000` under NANP 555-0100..0199) or synthetic sample numbers (`+919876543210`) in samples and documentation.
...
- Active listening speaking ratios and silence thresholds are prompt-guided system instruction directives, not hard provider-enforced constraints. Actual speech distribution depends on LLM adherence to task instructions during live calls.
