...
6. Call candidates strictly one at a time, in priority order:
   ...
   - treat voicemail, no answer, an unclear answer, or a failed call as a decline
     for this run; never as an acceptance
...
- An ambiguous outcome is a decline, never an acceptance. Only a clear yes in the
