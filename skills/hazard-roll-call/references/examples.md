...
fictional reserved samples (`+1415555xxxx`).
...
1. Confirm: registry path, organisation name for the disclosure, emergency number (108 in India),
   cooling-centre address, wave size. State the count: "24 consented people, 6 call tasks of 4, plus
   escalation calls for anyone red or unreachable. This will consume CALL-E credit."
...
## Example 3: follow-ups two hours later
...
## Example 4: watch a feed and run automatically (drill mode)
