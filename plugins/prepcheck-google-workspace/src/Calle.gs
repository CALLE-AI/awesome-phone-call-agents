...
function buildTask_(patient, checkpoint, prepItems) {
  ...
  return [
    ...
    '',
    'BRANCHES:',
    '- All items done: confirm the appointment stands and end warmly.',
    '- Some items outstanding but the patient says they will complete them in',
    '  time: acknowledge, tell them you will call back to confirm, end.',
    '- Patient cannot complete the prep before the procedure: explain the',
    '  procedure cannot go ahead without it, tell them the clinic will call to',
    '  rebook, and that their slot will be released. Do not offer a new date.',
    ...
    '- You verify WHETHER a step was done. Nothing else.',
