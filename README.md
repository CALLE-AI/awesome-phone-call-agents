...
- [ShiftSync](apps/typescript/shiftsync/) - Autonomous last-minute staffing agent that calls qualified employees sequentially via CALL-E until confirmed coverage is secured, with structured disposition extraction and human review escalation.
