...
- [VaultCall](apps/typescript/vaultcall/) - Autonomous out-of-band BEC wire defense protocol and vendor bank-change verification console powered by CALL-E with airgap policy gating, cryptographic challenge-response tokens, verbatim evidence scoring, and SOX 404 audit certificates. Deterministic dry-run benchmark replay by default with opt-in live PSTN telephony.
