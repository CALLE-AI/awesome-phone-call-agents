...
- [`visitlock`](skills/visitlock/) - Batch research/clinical study visit confirmation by phone with CALL-E: structured RSVP (yes/no/reschedule/no_answer), idempotent dial ledger, and confirmation_rate HUD; fixture mode by default.
...
- [VisitLock](https://github.com/moscraciunxxx/visitlock-calle) - Batch research-visit confirmation via CALL-E with structured RSVP results, an idempotent dial ledger, and a fixture HUD by default.
...
| [`apps/python/visitlock`](apps/python/visitlock/) | Python | Catalog pointer to VisitLock: batch research-visit confirmation with structured RSVP schema, fixture/dry-run default, dial ledger, and confirmation_rate HUD. |
