...
- [DeskHelp](apps/web/deskhelp/) - Scheduled CALL-E phone work for education hubs: fourteen workflows off by default, approved wording with verbatim capture of anything else, promises kept as claims, and answers discarded unless the recipient's own words support them.
