...
| [FoundLine](https://github.com/unevil-warden/foundline) | TypeScript | Approval-gated lost-item recovery app with a no-call demo mode, privacy-safe disclosures, and structured CALL-E results. |
