...
| --- | --- | --- |
| [`apps/web/service-rescue`](apps/web/service-rescue/) | JavaScript / Node.js | Consent-first home-service availability app with a local no-call default, explicit live-call confirmation, and structured provider results for human review. |
