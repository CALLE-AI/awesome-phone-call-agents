...
- [`revenue-rescue`](skills/revenue-rescue/) - Autonomous, governed revenue recovery agent that detects failed payments, executes multi-step CALL-E interactions, and extracts structured resolutions with strict safety boundaries.
