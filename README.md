...
| [`apps/python/genesis-call-e-orchestrator`](apps/python/genesis-call-e-orchestrator/) | Python | Run appointment booking, consent-aware lead qualification, and vendor coordination as structured CALL-E workflows with preview and simulation paths. |
