...
| [`apps/typescript/bellwrench`](apps/typescript/bellwrench/) | TypeScript | Consent-first maintenance dispatch desk that calls an authorized vendor roster, verifies structured availability and quote evidence, and records a non-booking human decision. |
