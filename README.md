...
- [`lead-qualification-call`](skills/lead-qualification-call/) - Fills the roadmap request for inbound lead qualification by phone: one disclosed AI call that captures need, timeline, optional budget range, and consent-gated follow-up, with a no-call dry-run preview, a scoring playbook, and an evidence-backed structured result left for human sales review.
