...
| [`apps/python/car-import-lead-qualifier`](apps/python/car-import-lead-qualifier/) | Python | Qualify inbound vehicle import leads by phone: the dialled E.164 prefix resolves the market, locale, timezone, and calling window, with masked preview, state-file idempotency, and structured routing. |
