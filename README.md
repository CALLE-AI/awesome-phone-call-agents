...
- [SafeOps](https://github.com/saikumar040060/safeops) - Independent runtime authorization layer (permission, deterministic policy, risk engine, human approval) that a completed CALL-E call's outcome must pass through before any action executes; live-verified real outbound call confirming a refund reached human approval and executed exactly once, and a manipulated-transcript case was blocked by the risk engine with zero side effects. Live evidence and transcripts: [`submissions/calle.md`](https://github.com/saikumar040060/safeops/blob/main/submissions/calle.md).
