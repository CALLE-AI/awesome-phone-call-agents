...
| [\pps/python/civicscout\](apps/python/civicscout/) | Python | Proactive public works voice agent that calls citizens to verify 311 hazards, validates contractor permits mid-call via FastMCP, extracts structured telemetry, and orchestrates dynamic multi-agent departmental escalations.
