...
- [`call-the-parts`](skills/call-the-parts/) - Sit back while the agent calls the salvage yard, checks if they have the used part, and brings back stock, price, and pickup so you can keep working. You decide if it fits and whether to buy.
