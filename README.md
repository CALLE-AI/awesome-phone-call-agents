...
- - [GridGate](https://github.com/ashczar77/grid-gate) - Consent-gated emergency provider cascade and dispatch orchestrator during Eskom load-shedding with dry-run planning, early exit on fulfilled quotes, and CALL-E voice verification.
