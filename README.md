...
- [`emergency-dispatch-relay`](skills/emergency-dispatch-relay/) - Phones a response unit to relay a human-confirmed emergency dispatch decision in the unit's language and returns a tri-state structured answer (accepted, ETA, notes) while refusing to instruct the unit to move.
