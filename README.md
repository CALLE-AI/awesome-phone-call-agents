...
| [`apps/python/trip-rescue`](apps/python/trip-rescue/) | Python | Proactively calls a traveler the moment their booked flight is disrupted and rebooks them live on the call through the Duffel API, confirming a new itinerary before they have to open an app. Dry-run/fixture mode by default; live-verified against Duffel's test-mode sandbox. |
