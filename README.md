...
| [`apps/web/chargecheck`](apps/web/chargecheck/) | TypeScript / Next.js | Calls EV charging stations in real time via CALL-E to verify operational status, connector availability, and price before recommending one; demo mode by default. |
