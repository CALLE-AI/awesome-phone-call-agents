...
- [`accessible-outing-verifier`](skills/accessible-outing-verifier/) - Dual-phase outing accessibility verifier that bridges digital claims with bounded CALL-E phone calls, enforcing deterministic safety demotion for hedged answers.
