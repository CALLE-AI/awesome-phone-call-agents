...
- [VERIFY](https://github.com/DivineDomokuma10/verify) - Disclosed listing-verification app that calls the agent or landlord behind a rental ad and returns a schema-validated Verified/Warning/Inconclusive verdict with transcript evidence and an optional mock mode. |
