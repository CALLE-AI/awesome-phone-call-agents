...
- [Tokito](https://github.com/vimzh/tokito) - Small-team feedback app that turns reviewed questions and a validated contact list into approval-gated CALL-E outreach, preserves skipped and declined answers, and produces evidence-linked reports; text-call simulation is available without live calls.
