...
- [`missed-call-recovery`](skills/missed-call-recovery/) - Missed-call lead-recovery skill that calls the caller back, runs apologize/identify/urgency/booking qualification, and posts a schema-validated lead result with intent, urgency, and callback slot to the business dashboard.
