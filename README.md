...
- [Noon Arch AI Operations](apps/typescript/noon-arch-ai-operations/) - Converts project-system records into approval-gated CALL-E workflows for client follow-up, meetings, document expiry, and supplier quotes, with a bilingual no-call replay by default.
...
| [`apps/typescript/noon-arch-ai-operations`](apps/typescript/noon-arch-ai-operations/) | TypeScript / Vinext | Converts configurable project-system records into one-recipient CALL-E requests, validates structured outcomes, and previews optional write-back with a bilingual no-call replay by default. |
