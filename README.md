...
- [Tokito](https://github.com/vimzh/tokito) - Hackathon-built CALL-E feedback app for small teams that replaces ignored forms with approval-gated phone conversations, asks relevant follow-up questions, preserves skipped and declined answers, and turns transcripts into evidence-linked reports; includes a no-call text simulator.
