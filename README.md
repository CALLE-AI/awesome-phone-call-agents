...
- [OnTripFix](apps/python/ontripfix/) - Autonomous Airflow incident remediation with Call-E Voice AI for on-call engineer authorization and LangGraph StateGraph self-healing, with a dry-run default.
...
| [`apps/python/ontripfix`](apps/python/ontripfix/) | Python / FastAPI / React | Autonomous Airflow incident remediation with Call-E Voice AI on-call engineer authorization and LangGraph StateGraph self-healing, with a dry-run default. |
