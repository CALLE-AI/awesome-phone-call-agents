...
- [`photo-evidence-followup`](skills/photo-evidence-followup/) - Converts a parcel-inspection trace into one consent-gated CALL-E request for the exact replacement photo needed, with a deterministic no-call preview.
