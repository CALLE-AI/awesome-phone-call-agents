...
- [`insurance-call-recovery`](skills/insurance-call-recovery/) - Recover one unresolved insurance claim, billing, renewal, or policy-service task by phone with explicit approval, transcript-grounded evidence, and fail-closed human escalation when the requested outcome cannot be verified.
