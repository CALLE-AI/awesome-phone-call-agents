...
| [`apps/typescript/callpilot`](apps/typescript/callpilot/) | TypeScript | Business call workbench that turns a task into a goal-driven CALL-E call with plan review, safety-gated approval, live status tracking, and schema-valid structured results; dry-run demo mode by default. |
