...
- [Ringback](apps/powershell/ringback/) - Caregiver-proxy phone-call app that turns one natural-language situation into a verified single call with a fail-closed Confirmed/Needs Attention verdict; no-call dry run by default.
...
| [`apps/powershell/ringback`](apps/powershell/ringback/) | PowerShell / HTML | Natural-language caregiver situation in, verified single CALL-E call out, with contact resolution, masked numbers, and fail-closed confidence verdicts; dry-run preview default. |
